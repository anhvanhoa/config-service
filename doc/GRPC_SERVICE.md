...
├── config-service.go          # Main Production Service implementation
...
import (
	"config-service/domain/usecase/harvest_record"
	"config-service/domain/usecase/pest_disease_record"
	pb "config-service/proto_generated"
)
